...
- Los botones del paso 01 cambian según el estado: consulta y descarga de la ISO del servidor, cambio de ISO local o descarga de la última versión tras cargar una ISO local. Durante la búsqueda y descarga se muestra la opción de cancelar, que conserva la ISO local seleccionada si no se completa el cambio.
